...
* @Last Modified time: 2020-07-10 16:54:06
*/
//引入mongoose
...
db.once('open', function() {
	...
	UserModel.updateMany({name:'Tom'},{$set:{age:100}},(err,docs)=>{
		if(err){
			console.log('updateMany err::',err)
		}else{
			console.log('updateMany success::',docs);
		}
	})
	*/

	UserModel.updateMany({name:'Tom'},{name:'jisson'},(err,docs)=>{
		if(err){
			console.log('updateMany err::',err)
		}else{
			console.log('updateMany success::',docs);
